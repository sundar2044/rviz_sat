...
if("TRUE" STREQUAL "TRUE")
  set(nmea_navsat_driver_SOURCE_PREFIX /home/jeff/rviz_sat/src/nmea_navsat_driver)
  set(nmea_navsat_driver_DEVEL_PREFIX /home/jeff/rviz_sat/devel)
  ...
  set(nmea_navsat_driver_INSTALL_PREFIX /home/jeff/rviz_sat/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'nmea_navsat_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jeff/rviz_sat/src/nmea_navsat_driver/${idir}'.  Ask the maintainer 'Eric Perko <eric@ericperko.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${nmea_navsat_driver_dep}_FOUND)
      find_package(${nmea_navsat_driver_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${nmea_navsat_driver_dep} REQUIRED ${depend_list})
  endif()
