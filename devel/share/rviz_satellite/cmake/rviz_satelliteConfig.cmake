...
if("TRUE" STREQUAL "TRUE")
  set(rviz_satellite_SOURCE_PREFIX /home/jeff/rviz_sat/src/rviz_satellite)
  set(rviz_satellite_DEVEL_PREFIX /home/jeff/rviz_sat/devel)
  ...
  set(rviz_satellite_INSTALL_PREFIX /home/jeff/rviz_sat/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rviz_satellite' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'gcross <gcross.code@icloud.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'rviz_satellite' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jeff/rviz_sat/src/rviz_satellite/${idir}'.  Ask the maintainer 'gcross <gcross.code@icloud.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/jeff/rviz_sat/devel/lib;/opt/ros/indigo/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${rviz_satellite_dep}_FOUND)
      find_package(${rviz_satellite_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${rviz_satellite_dep} REQUIRED ${depend_list})
  endif()
